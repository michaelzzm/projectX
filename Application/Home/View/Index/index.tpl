  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-sm-12">
            <form id="loginform" action="{:U('/Index/login')}" role="form" method="post">
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-sm-12">
            <form id="registerform" action="{:U('/Index/register')}" role="form" method="post">
                    ...
                    <div class="col-md-8 col-sm-5">
                        ...
                        <div class="row copyright">
                            <div class="col-md-12 col-sm-5">
                                上海XX旅行社有限公司 国家旅游局经营许可证号: L-SH-XXXX 联系电话: 400-XXX-XXXX<br/>
                                地址：上海市XX区XX路XX号XX号楼XX室<br/>
                                Copyright 2014 旅心. All rights reserved.
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-5 blw">
                        <img src="__PUBLIC__/images/getqrcode.jpg" height="120px" />
                    </div>
                </div>
            </div>
        </footer>
